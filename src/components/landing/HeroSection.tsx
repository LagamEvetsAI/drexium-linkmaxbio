        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <Link to="/auth">
                <Button className="bg-[#FFD700] text-black hover:bg-[#FFD700]/90 font-bold text-lg px-10 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
            ...
            <div className="text-sm text-gray-400">
              ✨ Mais de 3.000 usuários ativos • 🚀 Criação em menos de 1 minuto
            </div>
          </div>
              ...
              <div className="w-80 h-96 bg-gradient-to-b from-gray-800 to-gray-900 rounded-3xl p-6 shadow-2xl border border-gray-700">
                <div className="bg-gradient-to-br from-neon-blue/20 to-neon-green/20 rounded-2xl p-4 h-full flex flex-col items-center justify-center">
                  ...
                  <div className="space-y-2 w-full">
                    <div className="bg-white/10 rounded-lg p-2 text-center text-sm">Instagram</div>
                    <div className="bg-white/10 rounded-lg p-2 text-center text-sm">YouTube</div>
                    <div className="bg-white/10 rounded-lg p-2 text-center text-sm">TikTok</div>
                    <div className="bg-white/10 rounded-lg p-2 text-center text-sm">Loja Online</div>
                  </div>
                </div>
              </div>
